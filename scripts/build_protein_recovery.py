...
SECTION = "Nutrition"
CARD_BLURB = "Right after a fracture, protein needs go up and appetite usually drops. What the evidence actually shows, why plant and animal protein both work, and easy food ideas for when you're not up to cooking."  # ~265 chars, matches neighbours
